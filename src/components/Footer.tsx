    ...
    <div className="footer-content">
      <div className="footer-logo">
        <span style={{display:'flex',alignItems:'center'}}>
          <svg style={{color:'#fff',fill:'#fff',fontSize:'32px',width:'32px',height:'32px',verticalAlign:'middle'}} viewBox="0 0 640 512">
        ...
        <span style={{fontSize:'1.5rem',fontWeight:600,verticalAlign:'middle',marginLeft:8}}>Matu-prep</span>
      </div>
